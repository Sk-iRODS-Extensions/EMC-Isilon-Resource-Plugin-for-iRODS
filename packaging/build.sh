...
if [ "$DETECTEDOS" == "RedHatCompatible" ] ; then # CentOS and RHEL and Fedora
    ...
    EXTENSION="rpm"
    SUFFIX="centos"$DETECTEDOSVERSION
    epmvar="REDHAT"
    ...
    EXTENSION="deb"
    SUFFIX="debian"$DETECTEDOSVERSION
    epmvar="DEB"
    ...
    EXTENSION="pkg"
    SUFFIX="solaris"$DETECTEDOSVERSION
    epmvar="PKG"
    ...
    EXTENSION="dmg"
    SUFFIX="macosx"$DETECTEDOSVERSION
    epmvar="OSX"
    ...
    EXTENSION="tar.gz"
    SUFFIX="archlnx"$DETECTEDOSVERSION
    epmvar="ARCH"
